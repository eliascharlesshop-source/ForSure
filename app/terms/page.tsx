        ...
        <AnimateOnScroll type="fade">
          <div className="prose dark:prose-invert max-w-none">
            <p>
              ...
              ForSure's website, products, and services (collectively, the
              "Services"). Please read these Terms carefully, and contact us if
            ...
            <p>
              ...
              the Site or through other communications. It's important that you
              review the Terms whenever we modify them because if you continue
              to use the Services after we have posted modified Terms on the
              Site, you are indicating to us that you agree to be bound by the
              modified Terms.
            </p>
            ...
            <p>
              ...
              with ForSure, and only in compliance with these Terms and all
              applicable laws. When you create your ForSure account, you must
              provide us with accurate and complete information.
            </p>

            <h2>4. Your Content</h2>
            <p>
              Our Services allow you to create, upload, post, send, receive, and
              store content. When you do that, you retain whatever ownership
              rights in that content you had to begin with. But you grant us a
              license to use that content to provide our Services.
            </p>
            ...
            <p>
              ...
              the security of your content and account, ForSure cannot guarantee
              that unauthorized third parties will not be able to defeat our
              security measures. Please notify us immediately of any compromise
            ...
            <p>
              ...
              that are not owned or controlled by ForSure. ForSure has no
            ...
            <p>
              ...
              explicitly disclaim any warranties of merchantability, fitness for
              a particular purpose, quiet enjoyment, or non-infringement, and
              any warranties arising out of course of dealing or usage of trade.
            </p>

            <h2>10. Limitation of Liability</h2>
            <p>
              In no event will ForSure be liable to you or any third party for
              any direct, indirect, incidental, special, consequential, or
              punitive damages arising out of or relating to your access to or
