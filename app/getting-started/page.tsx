...
cd ForSure`}
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold">
              2. Create Your First ForSure File
            </h2>
            <p>
              Create a new file with a .forsure extension and define your
              project structure:
            </p>
            <CodeExample
...
root:
  ...
  - README.md`}
          ...
          <div className="space-y-4">
            ...
            <p>
              Review the sample .forsure files included in the repository to get
