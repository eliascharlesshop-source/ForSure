...
export function ConflictResolutionHelper({
  conflicts,
  onApplySuggestion,
}: ConflictResolutionHelperProps) {
  ...
  const smartSuggestions = [
    {
      ...
      description:
        "Automatically merge changes that don't conflict with each other",
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          AI-powered suggestions to help resolve merge conflicts efficiently
        </CardDescription>
      </CardHeader>
      <CardContent>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-sm">
                      High Priority ({highPriorityConflicts.length})
                    </span>
                  </div>
              ...
              {mediumPriorityConflicts.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-sm">
                      Medium Priority ({mediumPriorityConflicts.length})
                    </span>
                  </div>
                  <div className="space-y-2">
              ...
              {lowPriorityConflicts.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-sm">
                      Low Priority ({lowPriorityConflicts.length})
                    </span>
                  </div>
                  <div className="space-y-2">
            ...
            <div className="grid gap-4">
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-2 text-xs text-muted-foreground">
                  ...
                  <div>
                    • Current version has additional feature implementations
                  </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-2 text-xs text-muted-foreground">
                  <div>
                    • Consider using target version for dependency updates
                  </div>
